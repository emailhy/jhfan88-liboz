...
oz::ffmpeg_encoder::ffmpeg_encoder(impl *p) : m(p) {}


oz::ffmpeg_encoder::~ffmpeg_encoder() {
}


bool oz::ffmpeg_encoder::append_frame( const uint8_t *buffer ) {
    int out_size, ret;
    AVCodecContext *c;
